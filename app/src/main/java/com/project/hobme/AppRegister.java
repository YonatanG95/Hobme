...
//     * @param email
//     */
//    private void checkIfUsernameExists(final String email) {
...
//                        Log.d(TAG, "checkIfUsernameExists: FOUND A MATCH: " + singleSnapshot.getValue(UserEntry.class).getFullName());
